...
<header class="" id="home" style="background-color: black;margin: 0;height: auto;padding: 30px;">
                ...
                <div id="main-nav" class="stellarnav">
                    <ul id="nav" class="nav navbar-nav">
                        ...
                        <li><a href>Other Pages</a>
                            <ul>
                                <li><a href="WEB-INF/packagel_tracking.jsp">Tracking</a></li>
...
<div class="header">
    <h1 style="margin-left: 250px;">404—Page Not Found</h1>
</div>

<main class="main-content">
    <section class="error-details">
        <h2>Oops! Looks like. You don't have permission to access this web page!</h2>
    ...
    <div class="image-container">
        <img src="img/404.png" alt="Delivery person">
    </div>
</main>

                        ...
                        <div class="container">
                            ...
                            <div id="main-nav" class="stellarnav">
                                <ul id="nav" class="nav navbar-nav">
                                    ...
                                    <li><a href="dashbord.html">Service</a>
                                    </li>
                                    <li><a href>Other Pages</a>
                                        <ul>
                                            <li><a href="tracking.html">Tracking</a></li>
                                            <li><a href="coming-soon.html">Coming Soon</a></li>
                                            <li><a href="admindashbord.html">Admin</a></li>
                                            <li><a href="reguster_parcels.html">Register package</a></li>
                                            <li><a href="parcels.html">Packages</a></li>
                                            <li><a href="plan_delivery_route.html">Plan Delivery Route</a></li>
                                            <li><a href="update_delivery_route.html">Update Delivery Route</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#">Blog</a></li>

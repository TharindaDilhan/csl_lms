                            ...
                            <div id="main-nav" class="stellarnav">
                                <ul id="nav" class="nav navbar-nav">
                                    ...
                                    <li><a href>Other Pages</a>
                                        <ul>
                                            <li><a href="<%=BASE_PATH%>/admin/register_parcels">Register package</a></li>
                                            <li><a href="<%=BASE_PATH%>/delivery/parcels">Packages</a></li>
                                            <li><a href="<%=BASE_PATH%>/admin/set_routine">Plan Delivery Route</a></li>
                                            <li><a href="<%=BASE_PATH%>/admin/update_routine">Update Delivery Route</a></li>
                                            <li><a href="<%=BASE_PATH%>/delivery/parcels">Update Parcel Tracking</a></li>
                                            <li><a href="<%=BASE_PATH%>/delivery/view_routine">View Delivery Route</a></li>

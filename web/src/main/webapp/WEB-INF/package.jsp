<%@ page import="java.util.List" %>
    <%@ page import="com.csl.ejb.entity.Parcel" %>
        <!DOCTYPE html>
        <%String BASE_PATH = request.getContextPath();%>
            ...
            <body class="home-one">
                ...
                <nav class="breadcrumb">
                    <a href="#">Home</a> / <span>Package List</span>
                </nav>

                <section class="services-intro">
                    <h2>CSL transport services is a full service, freight <span class="highlight">transportation</span> and <span class="highlight">logistics</span> company.</h2>
                </section>
                <div class="quote-container">
                    <table class="parcels-table">
                        ...
                        <tbody>
                            <%
                            List<Parcel> parcels = (List<Parcel>) request.getSession().getAttribute("parcels");
                        ...
                        %>
                                ...
                                <tr>
                                    ...
                                    <td><a href="<%=BASE_PATH%>/user/parcel_tracking_update?id=<%=parcel.getId()%>" class="update">Update</a></td>
                                </tr>

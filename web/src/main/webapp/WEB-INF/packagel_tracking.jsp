    ...
    <div class="header-top-area"> -->
        ...
        <main class="main-content">
            <section class="track-order">
                ...
                <p>Enter the order number you would like to track in the form below. Here are the demo order numbers: <span class="demo-numbers">001, 002, 003, 004</span></p>
                <form action="<%=BASE_PATH%>/user/tracking" method="get">
                    <label for="order-number">Order Number:</label>
                    <input type="text" id="order-number" name="trackNo" placeholder="Order Number...">

<%@ page import="com.csl.ejb.entity.Route" %>
    <!DOCTYPE html>
    <%String BASE_PATH = request.getContextPath();%>
        ...
        <body class="home-one">
            ...
            <%Route routine = (Route) session.getAttribute("routine");%>
                <div class="header">
                ...
                <div class="main-container">
                    ...
                    <form action="<%=BASE_PATH%>/admin/update_routine" method="post">
                        <div class="planner-container">
                            <div class="map-container">
                                <img src="<%=BASE_PATH%>/img/map.jpeg" alt="Delivery Route Map">
                            </div>
                            <div class="controls-container">
                                <div class="dropdown-container">
                                    <label for="deliveryguy">Delivery Guy: Tharinda</label>
                                </div>
                                <div class="form-group mt-4">
                                    <label style="font-weight: bolder;">Current Root:</label>
                                    <span>H,<%=routine.getRoutePath()%>,H</span>
                                </div>
                                <div class="address-list-container">
                                    <h2 for="address-list">Address List</h2>
                                    <ul class="address-list">
                                        No.37/15, Samagi Mawatha Elpitiya<br> No.21/15, sangamiththa road, Galle fort<br> No.07, sinipalla, bamunugama, Makadura<br>
                                    </ul>
                                </div>
                            </div>
                        </div>

<%@ page import="com.csl.ejb.enums.DeliveryState" %>
    <!DOCTYPE html>
    <html lang="en">
    <%String BASE_PATH = request.getContextPath();%>
        ...
        <body class="home-one">
                            ...
                            <div class="container">
                                ...
                                <div id="main-nav" class="stellarnav">
                                    <ul id="nav" class="nav navbar-nav">
                                        <li><a href="aadmin_dashbord.jsp">home</a></li>
                                        <li><a href="#">about</a>
                                            <ul>
                                                <li><a href="#">About
                                                    Profile</a></li>
            ...
            <div class="header">
                <h1>Update Tracking shipment</h1>
            </div>
            <nav class="breadcrumb">
                <a href="#">Home</a> / <span>Update Tracking shipment</span>
            </nav>

            <main class="main-content">
                <form action="<%=BASE_PATH%>/user/tracking" method="post">
                    <section class="track-order">
                        <h2>Tracking State</h2>
                        <label for="order-number">Order Number:</label>
                        <label for="state">Tracking State</label>
                        <select id="state" name="state">
                            <option value="">Select</option>
                            <option value="<%=DeliveryState.ARRIVED_AT_WAREHOUSE%>">Arrived at warehouse</option>
                            <option value="<%=DeliveryState.PARCEL_RELABELED%>">Parcel Relabeled</option>
                            <option value="<%=DeliveryState.OUT_FOR_DELIVERY%>">Out for Delivery</option>
                            <option value="<%=DeliveryState.DELIVERED%>">Delivered</option>
                <!-- Add more options here -->
                        </select>
                        <input style="display: none" value="<%=request.getSession().getAttribute(" id ")%>" name="id" />
